...
INSERT INTO `prop_ns` (`id`, `prefix`, `uri`) VALUES (0, 'd', 'DAV:'),(1, 'c', 'urn:ietf:params:xml:ns:caldav'),(2, 'cs', 'http://calendarserver.org/ns/'),(3, 'ics', 'http://icalendar.org/ns/'),(4, 'card', 'urn:ietf:params:xml:ns:carddav'),(5, 'vc', 'urn:ietf:params:xml:ns:vcard'),(6, 'ical', 'http://apple.com/ns/ical/'),(7, 'dp', 'DAV:Push');
CREATE TABLE IF NOT EXISTS `calendar` (
    `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
    `uri` varbinary(255) NOT NULL DEFAULT '' COMMENT '日历地址',
    `owner_id` int UNSIGNED NOT NULL DEFAULT '0' COMMENT '用户id',
    `displayname` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin GENERATED ALWAYS AS (json_unquote(json_extract(`prop`,_utf8mb4'$."d:displayname"'))) STORED,
    `calscale` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'GREGORIAN',
    `tzid` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'Asia/Shanghai',
    `component_set` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'vevent,vtodo' COMMENT '支持的组件',
    `prop` json NOT NULL,
    `ics_prop` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
    `ics_data` mediumblob,
    `last_modified` char(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin GENERATED ALWAYS AS (json_unquote(json_extract(`prop`,_utf8mb4'$."d:getlastmodified"'))) STORED,
    `etag` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin GENERATED ALWAYS AS (json_unquote(json_extract(`prop`,_utf8mb4'$."d:getetag"'))) STORED COMMENT '修改标识',
    `sync_token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin GENERATED ALWAYS AS (json_unquote(json_extract(`prop`,_utf8mb4'$."d:sync-token"'))) STORED,
...
CREATE TABLE IF NOT EXISTS `change` (
    ...
    `sync_token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
    `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
